...
import styles from './availableVariantSzt.module.css'
import { InputUI } from '../../../../UI/input/input'
import { Variant } from './variant'
import { closeMessage, showMessage } from '../../../../optionsSlice'
import { SETTINGS, WARNING_MESSAGE } from '../../../../const/const'
import { addKsgToDataset } from './datasetSztSlice'

export const AvailableVariantSzt = () => {
  const [textKsg, setTextKsg] = useState('')
  const variants = useSelector((state) => state.datasetSzt.variants)

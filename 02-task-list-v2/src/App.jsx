...
export const App = () => {
  ...
  return (
    <Context.Provider value={{ addTask, activeTasks, deleteTask, completeTask, currentTime, completedTasks }}>
      <div className="app">
...
const TaskList = () => {
  const { activeTasks, deleteTask, completeTask, currentTime } = useContext(Context)

  return (
    <Task.Provider value={{ deleteTask }}>
...
const CompletedTaskList = () => {
  const { completedTasks, deleteTask } = useContext(Context)
...
const TaskItem = ({ task, completeTask, isOverdue }) => {
  const { deleteTask } = useContext(Task)
...
const Footer = () => {
  return (
    <footer className="footer">
      <p>Technologies and React concepts used: React, JSX, props, useEffect, useState, component composition, conditional rendering, array methods (map, filter), event handling.</p>
    </footer>
  )
}
